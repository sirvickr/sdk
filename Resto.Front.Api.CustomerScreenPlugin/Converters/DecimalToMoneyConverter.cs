    ...
    public sealed class DecimalToMoneyConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            switch (moneyFormat)
            {
                ...
                default:
                    throw new ArgumentOutOfRangeException("parameter", parameter, "Money format value not supported");
            }
        }
        ...
        private static decimal MoneyRound(decimal sum, int decimals, decimal minimumDenomination)
        {
            if (minimumDenomination < 0m)
                throw new ArgumentOutOfRangeException("minimumDenomination", minimumDenomination, "minimumDenomination must be nonnegative");
